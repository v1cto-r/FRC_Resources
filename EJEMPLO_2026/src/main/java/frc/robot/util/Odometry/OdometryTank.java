...
public class OdometryTank extends SubsystemBase {
    // Pose estimator
    ...
    public OdometryTank(
        ...
        Supplier<Double> m_leftDistanceSupplier,
        Supplier<Double> m_rightDistanceSupplier,
        Pose2d initialPose,
        double visionPeriod,
        ...
        this.m_leftDistanceSupplier = m_leftDistanceSupplier;
        this.m_rightDistanceSupplier = m_rightDistanceSupplier;
    ...
    public synchronized void resetPosition(Pose2d pose) {
        this.m_poseEstimator.resetPosition(this.m_gyroAngleSupplier.get(), m_leftDistanceSupplier.get(), m_rightDistanceSupplier.get(), pose);
    }
    ...
    public synchronized void setVisionPose() {
        ...
        m_poseEstimator.resetPosition(this.m_gyroAngleSupplier.get(), m_leftDistanceSupplier.get(), m_rightDistanceSupplier.get(), estimate.get().pose);
    }
