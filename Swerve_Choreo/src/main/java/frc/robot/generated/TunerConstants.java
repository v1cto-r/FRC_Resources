...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs() // <- COnfigurar giro de swerve modulos
        .withKP(50).withKI(0).withKD(0.0)
        .withKS(0.1).withKV(1.0).withKA(0)
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(3.5); // <- Velocidad Maxima
